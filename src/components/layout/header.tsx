...
const Header = () => {
  const [searchQuery, setSearchQuery] = useState("");
  // Hamburger menü açılıp kapanması
  ...
  return (
    <header className="w-full">
      ...
      <div className="bg-[#F0F4F8] py-1">
        <div className="container mx-auto flex justify-end items-center px-4">
          {/* B2B, Client Care, Contact, Favorite - YALNIZCA md+ ekranda */}
          ...
          <div className="flex items-center">
            ...
            {/* Search Input (her zaman görünsün) */}
            <div className="relative mr-4">
              <Input
                prefix={
                  <SearchOutlined
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          {/* Menü paneli */}
          <div className="absolute top-0 right-0 w-3/4 max-w-[250px] h-full bg-white p-4 flex flex-col">
            <button
              onClick={() => setMobileMenuOpen(false)}
            ...
            {/* B2B, Client Care, Contact, Favorite */}
            <Link
              href="/"
      ...
      {/* Main Navigation (Logo, Popular Destinations) */}
      <div className="container mx-auto py-4 px-4">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <div className="flex items-center">
          ...
          {/* Popular Destinations (md+ ekranlarda) */}
          <nav className="hidden md:flex space-x-4">
            <Link
              href="/"
              className="text-sm text-black hover:text-[#0057b8] w-[139px] h-[17px] flex items-center"
