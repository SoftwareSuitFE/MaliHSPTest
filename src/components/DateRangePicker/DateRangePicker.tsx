  ...
  const datePickerContent = (
    ...
    >
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mb-4 pb-3 border-b border-gray-200">
          <div className="flex items-center space-x-4">
            <span className="text-orange-500 font-medium">{t("DateRangePicker", "nights", { count: nights })}</span>
            <span className="text-gray-600">
              {displayStartDate ? displayStartDate.format("D MMM") : ""} 
              {displayStartDate && displayEndDate ? " - " : ""}
              {displayEndDate ? displayEndDate.format("D MMM") : ""}
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center">
              ...
              >
                <span className="ml-1">
                  <span className="font-medium">{t("DateRangePicker", "plusMinusDays")}</span>{" "}
                  <span className="text-gray-400">{t("DateRangePicker", "flexibleDates")}</span>
                </span>
              </Checkbox>
            </div>
            <button 
