...
const SearchForm = () => {
  ...
  return (
    ...
    >
      {/* From Field */}
      <div className="flex items-center h-full bg-white rounded-lg" style={{ flex: 1 }}>
        <div className="pl-4">
          <svg
            width="24"
            height="24"
        ...
        <div className="flex flex-col px-3">
          ...
          <input
            ...
            value={fromLocation}
            onChange={(e) => setFromLocation(e.target.value)}
            className="w-full text-base font-medium text-[#142347] focus:outline-none bg-transparent"
      ...
      {/* Date Field */}
      <div className="flex items-center h-full bg-white rounded-lg" style={{ width: "160px" }}>
        <div className="pl-4">
          <svg
            width="24"
            height="24"
        ...
        <div className="flex flex-col px-3">
          ...
          <div className="font-medium text-base text-[#142347]">15 Apr</div>
        </div>
      </div>
      ...
      <div className="flex items-center h-full bg-white rounded-lg" style={{ width: "160px" }}>
        ...
        <div className="flex flex-col px-3">
          <div className="text-gray-600 text-sm">Nights</div>
          <div className="font-medium text-base text-[#142347]">5 Nights</div>
        </div>
      </div>
      ...
      <div className="flex items-center h-full bg-white rounded-lg" style={{ width: "160px" }}>
        ...
        <div className="flex flex-col px-3">
          ...
          <div className="font-medium text-base text-[#142347]">2 People</div>
        </div>
      </div>
      ...
      <Button
        type="primary"
        onClick={handleSearch}
        className="h-full border-0 hover:bg-[#d88630] text-white px-6 text-base font-bold uppercase"
        style={{
          width: "160px",
          height: "60px",
          borderRadius: "8px",
