...
//         w-full
//       "
//       style={{ fontFamily: "inherit" }} // Font family Filters ile aynı
//     >
//       {/* Sol: Görsel */}
//       <div
//         className="
...
//           {/* Otel Adı */}
//           <h3
//             className="text-xl font-bold text-[#142347]"
//             style={{ margin: 0 }}
//           >
//             {hotel.name}
//           </h3>
...
//                 lineHeight: "100%",
//                 color: "#142347",
//                 whiteSpace: "nowrap", // Taşma engelle
//               }}
//             >
//               {hotel.location}
//             </span>
...
//             }}
//           >
//             {/* Üst kısım: Eski Fiyat sağ üstte, alt satırda from PP ve Yeni Fiyat */}
//             <div
...
//               {/* from PP + yeni fiyat (yanyana, küçük gap) */}
//               <div
//                 style={{
//                   display: "flex",
//                   alignItems: "baseline",
...
const HotelCard = ({ hotel }: HotelCardProps): JSX.Element => {
  return (
    ...
    >
      ...
      >
        {/* Üst Row */}
        <div className="flex flex-col gap-2" style={{ width: "409px", height: "73px" }}>
        ...
        {/* Alt Row */}
        <div className="flex" style={{ width: "409px", height: "142px", gap: "8px" }}>
          {/* Sol: List */}
          <div
            style={{
              width: "200.5px",
          ...
          >
            <div className="flex items-center gap-2 text-sm text-[#142347]">
              <UserOutlined />
              <span>{hotel.adults} Adults - {hotel.children} Child</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-[#142347]">
              <CalendarOutlined />
              <span>{hotel.date}</span>
