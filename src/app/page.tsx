...
// home/page.tsx dosyasında değişiklik yapın
'use client';
...
// SearchForm bileşenini dinamik olarak import edin ve SSR'yi devre dışı bırakın
const SearchForm = dynamic(() => import('@/components/home/searchForm'), { 
  ssr: false,
  loading: () => (
    <div className="w-full h-16 bg-white/30 backdrop-blur-sm rounded-lg animate-pulse">
      {/* Loading durumu */}
    </div>
  )
});
