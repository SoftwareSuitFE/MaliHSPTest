  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="max-w-3xl w-full flex flex-col items-center justify-center text-center">
        {/* Animated 404 */}
        <div className={`relative mb-6 transition-all duration-700 transform ${isLoaded ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}>
          <div className="text-[120px] md:text-[180px] font-bold text-orange-500 opacity-10 select-none">404</div>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className={`w-24 h-24 md:w-32 md:h-32 transition-all duration-700 transform ${isLoaded ? 'rotate-0 opacity-100' : 'rotate-90 opacity-0'}`}>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
        ...
        {/* Main Content Card */}
        <div className={`bg-white shadow-xl rounded-xl p-8 md:p-12 w-full max-w-2xl mb-8 border border-gray-100 transition-all duration-700 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">{t("NotFound", "title")}</h1>
          <h2 className="text-xl text-orange-500 font-semibold mb-4">{t("NotFound", "message")}</h2>
          ...
          <div className="relative h-24 mb-10">
            ...
            <div className="absolute left-0 top-0">
              <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center animate-float" style={{ animationDelay: "0s" }}>
                <svg 
            ...
            <div className="absolute left-1/4 bottom-0">
              <div className="w-10 h-10 bg-orange-50 rounded-full flex items-center justify-center animate-float" style={{ animationDelay: "0.5s" }}>
                <svg 
            ...
            <div className="absolute left-1/2 top-0 transform -translate-x-1/2">
              <div className="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center animate-float" style={{ animationDelay: "1s" }}>
                <svg 
            ...
            <div className="absolute right-1/4 bottom-0">
              <div className="w-10 h-10 bg-red-50 rounded-full flex items-center justify-center animate-float" style={{ animationDelay: "1.5s" }}>
                <svg 
            ...
            <div className="absolute right-0 top-0">
              <div className="w-12 h-12 bg-yellow-50 rounded-full flex items-center justify-center animate-float" style={{ animationDelay: "2s" }}>
                <svg 
